...
namespace chemApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Number : BaseDataType,  IEquatable<Number>
    {
        /// <summary>
        ...
        public Number(string DataType = null, string Name = null, string Prompt = null, string Value = null, string Unit = null, string UnitType = null)
        {
            // to ensure "DataType" is required (not null)
            if (DataType == null)
            {
                throw new InvalidDataException("DataType is a required property for Number and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for Number and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Prompt == null)
            {
                throw new InvalidDataException("Prompt is a required property for Number and cannot be null");
            }
            else
            {
                this.Prompt = Prompt;
            ...
            if (Value == null)
            {
                throw new InvalidDataException("Value is a required property for Number and cannot be null");
            }
            else
            {
                this.Value = Value;
            ...
            if (Unit == null)
            {
                throw new InvalidDataException("Unit is a required property for Number and cannot be null");
            }
            else
            {
                this.Unit = Unit;
            ...
            if (UnitType == null)
            {
                throw new InvalidDataException("UnitType is a required property for Number and cannot be null");
            }
            else
            {
