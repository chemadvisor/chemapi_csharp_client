...
namespace chemApiClient.Model
{
    ...
    public partial class Entries :  IEquatable<Entries>
    {
        ...
        /// Initializes a new instance of the <see cref="Entries" /> class.
        /// </summary>
        /// <param name="Entry">A collection of entry objects (required).</param>
        /// <param name="Links">Links.</param>
        public Entries(List<Entry> Entry = null, Links Links = null)
        {
            // to ensure "Entry" is required (not null)
            if (Entry == null)
            {
                throw new InvalidDataException("Entry is a required property for Entries and cannot be null");
            }
            else
            {
                this.Entry = Entry;
        ...
        /// </summary>
        /// <value>A collection of entry objects</value>
        ...
        public bool Equals(Entries other)
        {
            ...
            return 
                (
                    ...
                    this.Entry != null &&
                    this.Entry.SequenceEqual(other.Entry)
                ) && 
                (
