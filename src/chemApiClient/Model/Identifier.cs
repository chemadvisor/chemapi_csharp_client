...
namespace chemApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Identifier : BaseDataType,  IEquatable<Identifier>
    {
        /// <summary>
        ...
        public Identifier(string DataType = null, string Name = null, string Prompt = null, string Value = null)
        {
            // to ensure "DataType" is required (not null)
            if (DataType == null)
            {
                throw new InvalidDataException("DataType is a required property for Identifier and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for Identifier and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Prompt == null)
            {
                throw new InvalidDataException("Prompt is a required property for Identifier and cannot be null");
            }
            else
            {
                this.Prompt = Prompt;
            ...
            if (Value == null)
            {
                throw new InvalidDataException("Value is a required property for Identifier and cannot be null");
            }
            else
            {
                this.Value = Value;
