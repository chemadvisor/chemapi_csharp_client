...
namespace chemApiClient.Api
{
    ...
    public interface ITagsApi : IApiAccessor
    {
        ...
        ApiResponse<Tags> GetTagsWithHttpInfo (string q = null, string appKey = null, string appId = null);
        ...
        System.Threading.Tasks.Task<Tags> GetTagsAsync (string q = null, string appKey = null, string appId = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Tags>> GetTagsAsyncWithHttpInfo (string q = null, string appKey = null, string appId = null);
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        /// <summary>
        /// Get All Available Tags Gets a collection of **tag** objects. 
        /// </summary>
        /// <exception cref="chemApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="q">Search filter is based on the syntax used for find in mongoDB.  For more information, visit &lt;a href&#x3D;\&quot;https://developer.chemadvisor.io/docs/integrate/codeExamplesQ\&quot; target&#x3D;\&quot;blank\&quot;&gt;https://developer.chemadvisor.io/docs/integrate/codeExamplesQ&lt;/a&gt;. (optional)</param>
        /// <param name="appKey"> (optional)</param>
        /// <param name="appId"> (optional)</param>
        /// <returns>Tags</returns>
        public Tags GetTags (string q = null, string appKey = null, string appId = null)
        {
             ApiResponse<Tags> localVarResponse = GetTagsWithHttpInfo(q, appKey, appId);
        ...
        /// <param name="appId"> (optional)</param>
        /// <returns>ApiResponse of Tags</returns>
        public ApiResponse< Tags > GetTagsWithHttpInfo (string q = null, string appKey = null, string appId = null)
        {
        ...
        /// <param name="appId"> (optional)</param>
        /// <returns>Task of Tags</returns>
        public async System.Threading.Tasks.Task<Tags> GetTagsAsync (string q = null, string appKey = null, string appId = null)
        {
             ApiResponse<Tags> localVarResponse = await GetTagsAsyncWithHttpInfo(q, appKey, appId);
             return localVarResponse.Data;
        ...
        /// <param name="appId"> (optional)</param>
        /// <returns>Task of ApiResponse (Tags)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Tags>> GetTagsAsyncWithHttpInfo (string q = null, string appKey = null, string appId = null)
        {
